...
class CreateStartupsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('startups', function (Blueprint $table) {
            ...
            $table->string('video');
            $table->text('response_1', 65535)->nullable();
            $table->text('response_2', 65535)->nullable();
            $table->text('response_3', 65535)->nullable();
            $table->text('response_4', 65535)->nullable();
            $table->text('response_5', 65535)->nullable();
            $table->text('response_6', 65535)->nullable();
            $table->text('response_7', 65535)->nullable();
            $table->text('response_8', 65535)->nullable();            
            $table->text('response_9', 65535)->nullable();
            $table->text('response_10', 65535)->nullable();
            $table->text('response_11', 65535)->nullable();
            $table->text('response_12', 65535)->nullable();
            $table->text('response_13', 65535)->nullable();
            $table->text('response_14', 65535)->nullable();
            $table->text('response_15', 65535)->nullable();
