...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h4>Admin
      ...
      <i class="fa fa-angle-right margin-separator"></i>Categories<a href="<?php echo e(url('panel/admin/categories/add')); ?>" class="btn btn-sm btn-success no-shadow pull-right"><i class="glyphicon glyphicon-plus myicon-right"></i>Add Category</a>
   </h4>    
  </section>
