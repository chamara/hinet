...
<head>
  ...
  <link href="<?php echo e(asset('public/admin/css/AdminLTE.min.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo e(asset('public/admin/css/skins/_all-skins.min.css')); ?>" rel="stylesheet" type="text/css" />
          ...
          <div class="content-wrapper" style="margin: 0;">
            ...
            <section class="content">
              <div class="error-page text-center">
                ...
                <div class="btn-block">
                  <h3><i class="fa fa-warning text-red"></i> Page Not Found</h3>
                  <p class="btn-block">
                    Sorry page not found!
                    
                    <p class="btn-block">
                      <a href="<?php echo e(URL::to('/')); ?>">Go to home page</a>
                    </p>
