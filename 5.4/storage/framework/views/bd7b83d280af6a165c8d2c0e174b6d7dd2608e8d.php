          ...
          <form class="form-horizontal" method="post" action="<?php echo e(url('panel/admin/pages')); ?>">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" value="<?php echo e(old('title')); ?>" name="title" class="form-control" placeholder="Title">
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" value="<?php echo e(old('slug')); ?>" name="slug" class="form-control" placeholder="Slug">
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <textarea name="content"rows="5" cols="40" id="content" class="form-control" placeholder="Content"><?php echo e(old('content')); ?></textarea>
                </div>
              </div>
            </div>
