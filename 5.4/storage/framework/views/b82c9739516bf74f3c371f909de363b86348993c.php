...
<div class="content">
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="radio">
        <label class="padding-zero">
          <input type="radio" name="disable_startups_reg" <?php if( $settings->disable_startups_reg == '0' ): ?> checked="checked" <?php endif; ?> value="0" checked>
          No
        </label>
      </div>
       ...
       <div class="radio">
        <label class="padding-zero">
          <input type="radio" name="disable_startups_reg" <?php if( $settings->disable_startups_reg == '1' ): ?> checked="checked" <?php endif; ?> value="1">
          Yes
        </label>
      </div>
