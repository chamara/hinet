            ...
            <form class="form-horizontal" method="post" action="<?php echo e(url('panel/admin/statuses/add')); ?>" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo e(old('status')); ?>" id="name" name="name" class="form-control" placeholder="Name" required>
                  </div>
                </div>
              </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10" style="padding-top:6px">
                    <input checked="checked" name="mode" id="mode" type="checkbox" value="<?php echo e(old('mode')); ?>">
                  </div>
                </div>
              </div>
