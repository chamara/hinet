  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <h4>
       ...
       <a href="<?php echo e(url('panel/admin/categories/add')); ?>" class="btn btn-sm btn-success no-shadow pull-right"><i class="glyphicon glyphicon-plus myicon-right"></i> Add Status
       </a>
     </h4>
    </section>
