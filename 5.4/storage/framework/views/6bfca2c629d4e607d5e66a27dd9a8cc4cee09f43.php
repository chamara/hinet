            ...
            <form class="form-horizontal" method="POST" action="<?php echo e(url('panel/admin/startups/edit/'.$data->id)); ?>" enctype="multipart/form-data">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo e($data->title); ?>" name="title" class="form-control" placeholder="Name">
                  </div>
                </div>
              </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" min="1" autocomplete="off" value="<?php echo e($data->goal); ?>" name="goal" class="form-control onlyNumber" placeholder="1000000">
                  </div>
                </div>
              </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo e($data->location); ?>" name="location" class="form-control" placeholder="Location">
                  </div>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="finalized" class="form-control" >
                      ...
                      <option <?php if($data->finalized == '0'  && $data->status == 'active'): ?> selected="selected" <?php endif; ?> value="0">Active</option>
                      <option <?php if($data->finalized == '1'  && $data->status == 'active'): ?> selected="selected" <?php endif; ?> value="1">Finialized</option>
                    </select>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="radio">
                      <label class="padding-zero">
                        <input type="radio" name="opportunity" <?php if( $data->opportunity == '1' ): ?> checked="checked" <?php endif; ?> value="1" checked>
                        Yes
                      </label>
                    </div>
                    ...
                    <div class="radio">
                      <label class="padding-zero">
                        <input type="radio" name="opportunity" <?php if( $data->opportunity == '0' ): ?> checked="checked" <?php endif; ?> value="0">
                        No
                      </label>
                    </div>
                  </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="radio">
                      <label class="padding-zero">
                        <input type="radio" name="portfolio" <?php if( $data->portfolio == '1' ): ?> checked="checked" <?php endif; ?> value="1" checked>
                        Yes
                      </label>
                    </div>
                    ...
                    <div class="radio">
                      <label class="padding-zero">
                        <input type="radio" name="portfolio" <?php if( $data->portfolio == '0' ): ?> checked="checked" <?php endif; ?> value="0">
                        No
                      </label>
                    </div>
                  </div>
