...
<form action="{{ url('account') }}" method="post" name="form">
 ...
 <div class="form-group has-feedback">
   ...
   <input type="text" class="form-control input-lg" value="{{ e( $user->name ) }}" name="full_name" placeholder="Full Name">
 </div>

 <div class="form-group has-feedback">
   <label>Email</label>
   <input type="email" class="form-control input-lg" value="{{$user->email}}" name="email" placeholder="Email">
 </div>
