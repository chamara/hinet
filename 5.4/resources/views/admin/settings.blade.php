              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="radio">
                      <label class="padding-zero">
                          <input type="radio" name="disable_startups_reg" @if( $settings->disable_startups_reg == 'off' ) checked="checked" @endif value="off" checked>
                          No
                      </label>
                    </div>
                    ...
                    <div class="radio">
                      <label class="padding-zero">
                        <input type="radio" name="disable_startups_reg" @if( $settings->disable_startups_reg == 'on' ) checked="checked" @endif value="on">
                        Yes
                      </label>
                    </div>
                  </div>
